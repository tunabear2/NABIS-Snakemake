tjbae@ngate1:~/snakemake/data/fastq> cat bwa_job_script.sh 
#!/bin/bash
...
tjbae@ngate1:~/snakemake/data/fastq> cat bwa_script.sh 
#!/bin/bash

bwa="/s3/opt/bin/bwa"
ref_name="/s1/home/extRDA/tjbae/snakemake/data/reference/Homo_sapiens_assembly38.fasta"

${bwa} mem -t 8 -R '@RG\tID:SRR34149117\tSM:SRR34149117\tPL:ILLUMINA\tLB:lib1\tPU:unit1' ${ref_name} SRR34149117_trimmed1.fastq SRR34149117_trimmed2.fastq > SRR34149117.sam
